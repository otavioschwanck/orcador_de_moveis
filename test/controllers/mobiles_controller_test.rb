...
class MobilesControllerTest < ActionController::TestCase
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post :create, mobile: { budget_id: @mobile.budget_id, description: @mobile.description, name: @mobile.name }
    end
  ...
  test "should update mobile" do
    patch :update, id: @mobile, mobile: { budget_id: @mobile.budget_id, description: @mobile.description, name: @mobile.name }
    assert_redirected_to mobile_path(assigns(:mobile))
  end

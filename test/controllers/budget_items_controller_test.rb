...
class BudgetItemsControllerTest < ActionController::TestCase
  ...
  test "should create budget_item" do
    assert_difference('BudgetItem.count') do
      post :create, budget_item: { item_id: @budget_item.item_id, mobile_id: @budget_item.mobile_id, multiplicable: @budget_item.multiplicable, qtd: @budget_item.qtd }
    end
  ...
  test "should update budget_item" do
    patch :update, id: @budget_item, budget_item: { item_id: @budget_item.item_id, mobile_id: @budget_item.mobile_id, multiplicable: @budget_item.multiplicable, qtd: @budget_item.qtd }
    assert_redirected_to budget_item_path(assigns(:budget_item))
  end

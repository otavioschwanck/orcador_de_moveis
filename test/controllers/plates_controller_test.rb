...
class PlatesControllerTest < ActionController::TestCase
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post :create, plate: { height: @plate.height, mobile_id: @plate.mobile_id, plate_value: @plate.plate_value, qtd: @plate.qtd, width: @plate.width }
    end
  ...
  test "should update plate" do
    patch :update, id: @plate, plate: { height: @plate.height, mobile_id: @plate.mobile_id, plate_value: @plate.plate_value, qtd: @plate.qtd, width: @plate.width }
    assert_redirected_to plate_path(assigns(:plate))
  end
